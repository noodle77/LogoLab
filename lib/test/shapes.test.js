...
describe("Triangle", () => {
    test("Generates triangle logo with correct text, text color, and fill color.", () => {
        ...
        expect(genSVG).toContain("<text x='150' y='117' text-anchor='middle' fill='AFE1AF' font-size='50'>ABC</text>");
    });
});
...
describe("Square", () => {
    test("Generates square logo with correct text, text color, and fill color.", () => {
        ...
        expect(genSVG).toContain("<text x='150' y='100' text-anchor='middle' fill='AFE1AF' font-size='50'>ABC</text>");
    });
});
...
describe("Circle", () => {
    test("Generates circle logo with correct text, text color, and fill color.", () => {
        ...
        expect(genSVG).toContain("<text x='150' y='100' text-anchor='middle' alignment-baseline='middle' fill='AFE1AF' font-size='50'>ABC</text>");
    });
});